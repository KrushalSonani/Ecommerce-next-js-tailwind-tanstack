                            ...
                            <div>
                                <ul className='my-12 flex items-center justify-center gap-2 overflow-auto py-1 lg:mb-0'>
                                    {data.images.map((item, i) => {
                                        return (
                                            <li className='h-20 w-20' key={i}>
                                                <a className='h-full w-full'>
                                                    <div className={`${data.thumbnail === item ? 'border-blue-600' : ''} group p-2 flex h-full w-full items-center justify-center overflow-hidden rounded-lg border
                                                     bg-white hover:border-blue-600 dark:bg-black border-neutral-200 dark:border-neutral-800`} >
                                                        <Image
                                                            alt="Thumbnail"
                                                            draggable={false}
